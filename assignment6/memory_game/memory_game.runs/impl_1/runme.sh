...
HD_PWD='C:/Users/Jaswanth/memory_game/memory_game.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mem_game.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mem_game.tcl -notrace
