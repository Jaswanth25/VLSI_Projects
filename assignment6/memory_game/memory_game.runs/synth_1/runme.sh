...
HD_PWD='C:/Users/Jaswanth/memory_game/memory_game.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mem_game.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mem_game.tcl
